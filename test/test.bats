...
#   run ./bin/fa-lint -fasta test/duplicates_no_spaces.fasta
#   echo "$output"
#   [ "$status" -ne 0 ]
# }

# @test "Fasta file with duplicate ids and spaces should fail" {
#   run ./bin/fa-lint -fasta test/duplicates_with_spaces.fasta
#   echo "$output"
#   [ "$status" -ne 0 ]
# }

# @test "Fasta file with embedded PHP code should fail" {
#   run ./bin/fa-lint -fasta test/code.fasta
#   echo "$output"
#   [ "$status" -ne 0 ]
# }

# @test "Empty fasta file should fail" {
#   run ./bin/fa-lint -fasta test/empty.fasta
#   echo "$output"
#   [ "$status" -ne 0 ]
# }

# @test "Empty fasta file with a space should fail" {
#   run ./bin/fa-lint -fasta test/empty2.fasta
#   echo "$output"
#   [ "$status" -ne 0 ]
# }

# @test "Fasta file with one empty sequence should fail" {
#   run ./bin/fa-lint -fasta test/empty_seq.fasta
#   echo "$output"
#   [ "$status" -ne 0 ]
# }

# @test "Fasta file with an empty sequence should fail" {
#   run ./bin/fa-lint -fasta test/empty_seq2.fasta
#   echo "$output"
#   [ "$status" -ne 0 ]
# }
